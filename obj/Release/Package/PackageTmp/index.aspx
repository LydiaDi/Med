<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="MedicalRecord.index" EnableEventValidation="false" %>
    ...
    <%--<div class="b">--%>
        ...
        <asp:View ID="View1" runat="server">
                ...
                <%--<asp:Panel ID="Panel70" runat="server" GroupingText="入院概要" Font-Size="Small" Width="800px">--%>
                    ...
                    <%--日历修正--%>
                    <asp:TextBox ID="TextBox12" runat="server" Height="20px" Width="70px"></asp:TextBox>
                    ...
                    <asp:TextBox ID="TextBox12a" runat="server" Height="20px" Width="21px"></asp:TextBox>
                    

                    <asp:Label ID="Label12a" runat="server" Text=":" Enabled="True"></asp:Label>
                    <asp:TextBox ID="TextBox12b" runat="server" Height="20px" Width="21px"></asp:TextBox>
                    <asp:Label ID="Label12b" runat="server" Text=":"></asp:Label>
                    <asp:TextBox ID="TextBox12c" runat="server" Height="20px" Width="21px"></asp:TextBox>
                    <br />
                        <br />

                    <asp:Label ID="Label13" runat="server" Text="记录日期：" Height="20px" Width="96px"></asp:Label>
                    <%--日历修正--%>
                    <asp:TextBox ID="TextBox13" runat="server" Height="20px" Width="70px"></asp:TextBox>
                    ...
                    <asp:TextBox ID="TextBox13a" runat="server" Height="20px" Width="21px"></asp:TextBox>
                        <asp:Label ID="Label13a" runat="server" Text=":"></asp:Label>
                    <asp:TextBox ID="TextBox13b" runat="server" Height="20px" Width="21px"></asp:TextBox>
                        <asp:Label ID="Label13b" runat="server" Text=":"></asp:Label>
                    <asp:TextBox ID="TextBox13c" runat="server" Height="20px" Width="21px"></asp:TextBox>
                    <br /><br />
                    <%--实现时分秒的读入--%>
   ...
   <%-- </div>--%>
                ...
                <div class="e">
                    <asp:Panel ID="Panel6" runat="server" GroupingText="示踪信息" Font-Size="Medium">
                        <div class="b_2_1"><%--b2页面第一版块“示踪信息”部分--%>
                            ...
                            <%--日期修正--%>
                	        <asp:TextBox ID="TextBox44" runat="server" Height="20px" Width="70px"></asp:TextBox>
                            ...
                            <%--日期修正--%>
                            <asp:TextBox ID="TextBox40" runat="server" Height="20px" Width="70px"></asp:TextBox>
                    ...
                    <div class="b_2_2"><%--b2页面第二版块“SLN信息”部分--%>
                        <div style="height: 30px; width: 400px;">
                            ...
                            <%--日期修正--%>
                            <asp:TextBox ID="TextBox48" runat="server" Height="20px" Width="70px"></asp:TextBox>
                ...
                <div class="e">
                    <asp:Panel ID="Panel8" runat="server" GroupingText="示踪信息" Font-Size="Medium">
                        <div class="b_2_1"><%--因为此板块的内容样式与b2页面第一版块样式“b_2_1”相类似，故进行引用--%>
                            ...
                            <%--日历修正--%>
                    <asp:TextBox ID="TextBox59" runat="server" Height="20px" Width="70px"></asp:TextBox>
                    ...
                    <ajaxToolkit:CalendarExtender ID="CalendarExtender6" runat="server" TargetControlID="TextBox59" PopupButtonID="Image6" Format="yyyy-MM-dd" FirstDayOfWeek="Monday"/>
                            ...
                            <%--日历修正--%>
                    <asp:TextBox ID="TextBox63" runat="server" Height="20px" Width="70px"></asp:TextBox>
                    ...
                    <div class="b_2_2">
                        <div style="height: 30px; width: 400px;">
                            ...
                            <%--日历修正--%>
                    <asp:TextBox ID="TextBox67" runat="server" Height="20px" Width="70px"></asp:TextBox>
    ...
    <asp:View ID="View5" runat="server">
        ...
        <asp:View ID="View30" runat="server">
                <div class="e">
                    <asp:Panel ID="Panel67" runat="server" Font-Size="Medium" Width="100%" GroupingText="术后化疗">
                        <br />
                        ...
                        <br /><br />
                        <asp:Panel ID="Panel68" runat="server"  Width="100%" Enabled="False">
